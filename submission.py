...
def custom_search(graph, start, goal, data=None):
    ...
    If you implement this function and submit your code to , you'll be
...
def haversine_dist_heuristic(graph, v, goal):
    ...
    vLatLong = (math.radians(graph.nodes[v]["pos"][0]), math.radians(
        graph.nodes[v]["pos"][1]))
    goalLatLong = (math.radians(graph.nodes[goal]["pos"][0]), math.radians(
        graph.nodes[goal]["pos"][1]))
